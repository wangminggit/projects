...
// data - header
$data_row[] = array();
$data_row_header[0] = '登录名';
$data_row_header[1] = '姓名';
$data_row_header[2] = '后台用户组';
$data_row_header[3] = 'E-mail';
$data_row_header[4] = '状态';
...
foreach ($admin_users as $admin_user) {
    $data_row_data = array(
        ...
        $admin_user->getName(),
        $admin_user->getAdminUserGroupTxt(),
        $admin_user->getEmail(),
        $admin_user->getIsEnabledTxt(),
    );
...
$filename = "Admin_User " . date('Y_m_d') . ".xlsx";
ob_end_clean();
