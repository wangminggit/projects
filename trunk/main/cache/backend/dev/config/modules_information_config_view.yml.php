...
$response = $this->context->getResponse();
  ...
  $response->addStylesheet('/css/apps/admin/information/module.css', '', array ());
  ...
  $response->addJavascript('/js/3rd/laydate-v1.1/laydate/laydate.js', '', array ());
  $response->addJavascript('/js/apps/admin/information/module.js', '', array ());
