...
$response = $this->context->getResponse();
  ...
  $response->addStylesheet('/css/apps/admin/regulation/module.css', '', array ());
  ...
  $response->addJavascript('/js/apps/admin/regulation/module.js', '', array ());
