...
abstract class BaseNewsGeneratorConfiguration extends sfModelGeneratorConfiguration
{
  ...
  {
    return '%%id%% - %%_news_category_id%% - %%_title%% - %%_is_enable%% - %%page_view%% - %%_release_date%%';
  }
  ...
  {
    return array(  0 => 'news_category_id',  1 => 'title',  2 => 'release_date',  3 => 'image',  4 => 'summary',  5 => 'body',  6 => 'page_view',  7 => 'is_enable',);
  }
  ...
  {
    return array(  0 => 'id',  1 => '_news_category_id',  2 => '_title',  3 => '_is_enable',  4 => 'page_view',  5 => '_release_date',);
  }
  ...
  public function getFieldsDefault()
  {
    return array(
      ...
      'news_category_id' => array(  'is_link' => false,  'is_real' => true,  'is_partial' => false,  'is_component' => false,  'type' => 'Text',  'label' => '类别',),
