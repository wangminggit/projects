...
abstract class BaseSettingGeneralForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'seo_title'                  => new sfWidgetFormInputText(),
      'seo_meta_keywords'          => new sfWidgetFormInputText(),
      'seo_meta_description'       => new sfWidgetFormInputText(),
      'statistical_code'           => new sfWidgetFormTextarea(),
    ));
    ...
    $this->setValidators(array(
      ...
      'seo_title'                  => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'seo_meta_keywords'          => new sfValidatorString(array('max_length' => 500, 'required' => false)),
      'seo_meta_description'       => new sfValidatorString(array('max_length' => 500, 'required' => false)),
      'statistical_code'           => new sfValidatorString(array('required' => false)),
    ));
