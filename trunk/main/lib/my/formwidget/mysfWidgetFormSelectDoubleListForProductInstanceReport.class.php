 ...
 */
class mysfWidgetFormSelectDoubleListForProductInstanceReport extends sfWidgetForm {
    ...
    protected function configure($options = array(), $attributes = array()) {
        ...
        $this->addOption('unassociate', '<img src="/images/apps/admin/icon/admin_next.png" alt="取消关联" />');
        $this->addOption('associate', '<img src="/images/apps/admin/icon/admin_previous.png" alt="添加关联" />');
...
<div class="%class%">
  <div style="float: left">
    ...
    <div style="float: $float; margin: 30px 5px 0px 5px;">
      %associate%
      <br />
      %unassociate%
    </div>
...
EOF
    ...
    public function render($name, $value = null, $attributes = array(), $errors = array()) {
        ...
        $keyword_ids = AdminUserKeywordXrefPeer::getCurrentAdminUserLastRecordsKeywordIds();
        $associated = array();
        $unassociated = array();
        foreach ($choices as $key => $option) {
            if (in_array(strval($key), $keyword_ids)) {
