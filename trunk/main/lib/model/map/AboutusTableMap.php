...
/**
 * This class defines the structure of the 'aboutus' table.
 *
 *
 *
...
class AboutusTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'lib.model.map.AboutusTableMap';
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('ABOUTUS_CATEGORY_ID', 'AboutusCategoryId', 'INTEGER', 'aboutus_category', 'ID', false, 11, null);
	...
	{
    $this->addRelation('AboutusCategory', 'AboutusCategory', RelationMap::MANY_TO_ONE, array('aboutus_category_id' => 'id', ), 'RESTRICT', 'CASCADE');
