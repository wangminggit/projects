...
class SettingGeneralTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('SEO_META_KEYWORDS', 'SeoMetaKeywords', 'VARCHAR', false, 500, null);
		$this->addColumn('SEO_META_DESCRIPTION', 'SeoMetaDescription', 'VARCHAR', false, 500, null);
		$this->addColumn('STATISTICAL_CODE', 'StatisticalCode', 'LONGVARCHAR', false, null, null);
		// validators
	} // initialize()
