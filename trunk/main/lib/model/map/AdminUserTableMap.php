...
class AdminUserTableMap extends TableMap {
    ...
    $this->addRelation('Aboutus', 'Aboutus', RelationMap::ONE_TO_MANY, array('id' => 'created_by_admin_user_id', ), 'SET NULL', 'CASCADE');
    $this->addRelation('Information', 'Information', RelationMap::ONE_TO_MANY, array('id' => 'created_by_admin_user_id', ), 'SET NULL', 'CASCADE');
