...
class ProvinceTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'lib.model.map.ProvinceTableMap';
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('NAME_SHORT', 'NameShort', 'VARCHAR', false, 255, null);
		$this->addColumn('CAPITAL', 'Capital', 'VARCHAR', false, 255, null);
		// validators
	} // initialize()
