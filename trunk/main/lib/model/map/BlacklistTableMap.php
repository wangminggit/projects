...
/**
 * This class defines the structure of the 'blacklist' table.
 *
 *
 *
...
class BlacklistTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'lib.model.map.BlacklistTableMap';
	...
	{
	  // attributes
		$this->setName('blacklist');
		$this->setPhpName('Blacklist');
		$this->setClassname('Blacklist');
