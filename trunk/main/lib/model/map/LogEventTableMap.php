...
class LogEventTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('DISPLAY_ACTION', 'DisplayAction', 'VARCHAR', false, 255, null);
		// validators
	} // initialize()
	...
	{
    $this->addRelation('Log', 'Log', RelationMap::ONE_TO_MANY, array('id' => 'log_event_id', ), 'SET NULL', 'CASCADE');
	} // buildRelations()
