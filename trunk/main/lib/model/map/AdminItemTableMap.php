...
class AdminItemTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('IS_SHOW_MESSAGE', 'IsShowMessage', 'TINYINT', false, 4, null);
		$this->addColumn('GET_MESSAGE_ACTION', 'GetMessageAction', 'VARCHAR', false, 255, null);
		// validators
	} // initialize()
    ...
    $this->addRelation('AdminItemAdminUserGroupAccess', 'AdminItemAdminUserGroupAccess', RelationMap::ONE_TO_MANY, array('id' => 'admin_item_id', ), 'CASCADE', 'CASCADE');
	} // buildRelations()
