...
abstract class BaseCityPeer {
	...
	/** the column name for the PROVINCE_ID field */
	const PROVINCE_ID = 'city.PROVINCE_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'ProvinceId', 'Name', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'provinceId', 'name', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::PROVINCE_ID, self::NAME, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'PROVINCE_ID', 'NAME', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'province_id', 'name', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ProvinceId' => 1, 'Name' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'provinceId' => 1, 'name' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::PROVINCE_ID => 1, self::NAME => 2, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'PROVINCE_ID' => 1, 'NAME' => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'province_id' => 1, 'name' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(CityPeer::PROVINCE_ID);
			$criteria->addSelectColumn(CityPeer::NAME);
		} else {
			$criteria->addSelectColumn($alias . '.ID');
			$criteria->addSelectColumn($alias . '.PROVINCE_ID');
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseCityPeer', $criteria, $con);
		}
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = CityPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + CityPeer::NUM_COLUMNS;
		} else {
	...
	/**
	 * Returns the number of rows matching criteria, joining the related Province table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	...
	public static function doCountJoinProvince(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(CityPeer::PROVINCE_ID, ProvincePeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of City objects pre-filled with their Province objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinProvince(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (City) to $obj2 (Province)
				$obj2->addCity($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		ProvincePeer::addSelectColumns($criteria);
		$startcol3 = $startcol2 + (ProvincePeer::NUM_COLUMNS - ProvincePeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (City) to the collection in $obj2 (Province)
				$obj2->addCity($obj1);
	...
	{
		return $withPrefix ? CityPeer::CLASS_DEFAULT : CityPeer::OM_CLASS;
	}
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseCityPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
