 ...
 * @method     SettingGeneralQuery orderBySeoTitle($order = Criteria::ASC) Order by the seo_title column
 * @method     SettingGeneralQuery orderBySeoMetaKeywords($order = Criteria::ASC) Order by the seo_meta_keywords column
 * @method     SettingGeneralQuery orderBySeoMetaDescription($order = Criteria::ASC) Order by the seo_meta_description column
 * @method     SettingGeneralQuery orderByStatisticalCode($order = Criteria::ASC) Order by the statistical_code column
 *
 ...
 * @method     SettingGeneralQuery groupBySeoTitle() Group by the seo_title column
 * @method     SettingGeneralQuery groupBySeoMetaKeywords() Group by the seo_meta_keywords column
 * @method     SettingGeneralQuery groupBySeoMetaDescription() Group by the seo_meta_description column
 * @method     SettingGeneralQuery groupByStatisticalCode() Group by the statistical_code column
 *
 ...
 * @method     SettingGeneral findOneBySeoTitle(string $seo_title) Return the first SettingGeneral filtered by the seo_title column
 * @method     SettingGeneral findOneBySeoMetaKeywords(string $seo_meta_keywords) Return the first SettingGeneral filtered by the seo_meta_keywords column
 * @method     SettingGeneral findOneBySeoMetaDescription(string $seo_meta_description) Return the first SettingGeneral filtered by the seo_meta_description column
 * @method     SettingGeneral findOneByStatisticalCode(string $statistical_code) Return the first SettingGeneral filtered by the statistical_code column
 *
 ...
 * @method     array findBySeoTitle(string $seo_title) Return SettingGeneral objects filtered by the seo_title column
 * @method     array findBySeoMetaKeywords(string $seo_meta_keywords) Return SettingGeneral objects filtered by the seo_meta_keywords column
 * @method     array findBySeoMetaDescription(string $seo_meta_description) Return SettingGeneral objects filtered by the seo_meta_description column
 * @method     array findByStatisticalCode(string $statistical_code) Return SettingGeneral objects filtered by the statistical_code column
 *
...
abstract class BaseSettingGeneralQuery extends ModelCriteria
{
	...
	public function filterBySeoTitle($seoTitle = null, $comparison = null)
	{
		...
		return $this->addUsingAlias(SettingGeneralPeer::SEO_TITLE, $seoTitle, $comparison);
	}

	/**
	 * Filter the query on the seo_meta_keywords column
	 * 
	 * @param     string $seoMetaKeywords The value to use as filter.
	 *            Accepts wildcards (* and % trigger a LIKE)
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    SettingGeneralQuery The current query, for fluid interface
	 */
	public function filterBySeoMetaKeywords($seoMetaKeywords = null, $comparison = null)
	{
		if (null === $comparison) {
			if (is_array($seoMetaKeywords)) {
				$comparison = Criteria::IN;
			} elseif (preg_match('/[\%\*]/', $seoMetaKeywords)) {
				$seoMetaKeywords = str_replace('*', '%', $seoMetaKeywords);
				$comparison = Criteria::LIKE;
			}
		}
		return $this->addUsingAlias(SettingGeneralPeer::SEO_META_KEYWORDS, $seoMetaKeywords, $comparison);
	}

	/**
	 * Filter the query on the seo_meta_description column
	 * 
	 * @param     string $seoMetaDescription The value to use as filter.
	 *            Accepts wildcards (* and % trigger a LIKE)
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    SettingGeneralQuery The current query, for fluid interface
	 */
	public function filterBySeoMetaDescription($seoMetaDescription = null, $comparison = null)
	{
		if (null === $comparison) {
			if (is_array($seoMetaDescription)) {
				$comparison = Criteria::IN;
			} elseif (preg_match('/[\%\*]/', $seoMetaDescription)) {
				$seoMetaDescription = str_replace('*', '%', $seoMetaDescription);
				$comparison = Criteria::LIKE;
			}
		}
		return $this->addUsingAlias(SettingGeneralPeer::SEO_META_DESCRIPTION, $seoMetaDescription, $comparison);
	}

	/**
	 * Filter the query on the statistical_code column
	 * 
	 * @param     string $statisticalCode The value to use as filter.
	 *            Accepts wildcards (* and % trigger a LIKE)
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    SettingGeneralQuery The current query, for fluid interface
	 */
	public function filterByStatisticalCode($statisticalCode = null, $comparison = null)
	{
		if (null === $comparison) {
			if (is_array($statisticalCode)) {
				$comparison = Criteria::IN;
			} elseif (preg_match('/[\%\*]/', $statisticalCode)) {
				$statisticalCode = str_replace('*', '%', $statisticalCode);
				$comparison = Criteria::LIKE;
			}
		}
		return $this->addUsingAlias(SettingGeneralPeer::STATISTICAL_CODE, $statisticalCode, $comparison);
	}
