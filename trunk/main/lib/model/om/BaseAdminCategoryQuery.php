 ...
 * @method     AdminCategoryQuery orderByPosition($order = Criteria::ASC) Order by the position column
 *
 * @method     AdminCategoryQuery groupById() Group by the id column
 * @method     AdminCategoryQuery groupByName() Group by the name column
 * @method     AdminCategoryQuery groupByPosition() Group by the position column
 *
 ...
 * @method     AdminCategory findOneByPosition(int $position) Return the first AdminCategory filtered by the position column
 *
 ...
 * @method     array findByPosition(int $position) Return AdminCategory objects filtered by the position column
 *
	...
	public function filterByPosition($position = null, $comparison = null)
	{
		if (is_array($position)) {
			...
			if (isset($position['min'])) {
				$this->addUsingAlias(AdminCategoryPeer::POSITION, $position['min'], Criteria::GREATER_EQUAL);
				$useMinMax = true;
			}
			if (isset($position['max'])) {
				$this->addUsingAlias(AdminCategoryPeer::POSITION, $position['max'], Criteria::LESS_EQUAL);
				$useMinMax = true;
			}
			if ($useMinMax) {
				return $this;
		...
		return $this->addUsingAlias(AdminCategoryPeer::POSITION, $position, $comparison);
	}
