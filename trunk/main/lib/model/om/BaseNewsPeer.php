...
abstract class BaseNewsPeer {
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = NewsPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + NewsPeer::NUM_COLUMNS;
		} else {
	...
	public static function doCountJoinAdminUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(NewsPeer::CREATED_BY_ADMIN_USER_ID, AdminUserPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of News objects pre-filled with their AdminUser objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAdminUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (News) to $obj2 (AdminUser)
				$obj2->addNews($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (News) to the collection in $obj2 (AdminUser)
				$obj2->addNews($obj1);
