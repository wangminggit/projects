...
abstract class BaseRegulation extends BaseObject  implements Persistent
{
	...
	/**
	 * The value for the regulation_category_id field.
	 * @var        int
	 */
	protected $regulation_category_id;
	...
	/**
	 * @var        RegulationCategory
	 */
	protected $aRegulationCategory;
	...
	/**
	 * Initializes internal state of BaseRegulation object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [regulation_category_id] column value.
	 * 
	 * @return     int
	 */
	public function getRegulationCategoryId()
	{
	...
	/**
	 * Set the value of [regulation_category_id] column.
	 * 
	 * @param      int $v new value
	 * @return     Regulation The current object (for fluent API support)
	 */
	public function setRegulationCategoryId($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->regulation_category_id !== $v) {
			$this->regulation_category_id = $v;
			$this->modifiedColumns[] = RegulationPeer::REGULATION_CATEGORY_ID;
		}

		if ($this->aRegulationCategory !== null && $this->aRegulationCategory->getId() !== $v) {
			$this->aRegulationCategory = null;
		}

		return $this;
	} // setRegulationCategoryId()
	...
	public function setCreatedByAdminUserId($v)
	{
		...
		if ($this->created_by_admin_user_id !== $v) {
			...
			$this->modifiedColumns[] = RegulationPeer::CREATED_BY_ADMIN_USER_ID;
		}
	...
	public function setTitle($v)
	{
		...
		if ($this->title !== $v) {
			$this->title = $v;
			$this->modifiedColumns[] = RegulationPeer::TITLE;
		}
	...
	public function setReleaseDate($v)
	{
		...
		if ( $this->release_date !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = RegulationPeer::RELEASE_DATE;
			}
	...
	public function setImage($v)
	{
		...
		if ($this->image !== $v) {
			$this->image = $v;
			$this->modifiedColumns[] = RegulationPeer::IMAGE;
		}
	...
	public function setSummary($v)
	{
		...
		if ($this->summary !== $v) {
			$this->summary = $v;
			$this->modifiedColumns[] = RegulationPeer::SUMMARY;
		}
	...
	public function setBody($v)
	{
		...
		if ($this->body !== $v) {
			$this->body = $v;
			$this->modifiedColumns[] = RegulationPeer::BODY;
		}
	...
	public function setIsEnable($v)
	{
		...
		if ($this->is_enable !== $v || $this->isNew()) {
			$this->is_enable = $v;
			$this->modifiedColumns[] = RegulationPeer::IS_ENABLE;
		}
	...
	public function setPosition($v)
	{
		...
		if ($this->position !== $v) {
			$this->position = $v;
			$this->modifiedColumns[] = RegulationPeer::POSITION;
		}
	...
	public function setPageView($v)
	{
		...
		if ($this->page_view !== $v || $this->isNew()) {
			$this->page_view = $v;
			$this->modifiedColumns[] = RegulationPeer::PAGE_VIEW;
		}
	...
	public function setSeoKeywords($v)
	{
		...
		if ($this->seo_keywords !== $v) {
			$this->seo_keywords = $v;
			$this->modifiedColumns[] = RegulationPeer::SEO_KEYWORDS;
		}
	...
	public function setSeoDescription($v)
	{
		...
		if ($this->seo_description !== $v) {
			...
			$this->modifiedColumns[] = RegulationPeer::SEO_DESCRIPTION;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ($this->created_at !== $v) {
			$this->created_at = $v;
			$this->modifiedColumns[] = RegulationPeer::CREATED_AT;
		}
	...
	public function setUpdatedAt($v)
	{
		...
		if ($this->updated_at !== $v) {
			$this->updated_at = $v;
			$this->modifiedColumns[] = RegulationPeer::UPDATED_AT;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->regulation_category_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
	...
	public function ensureConsistency()
	{
		...
		if ($this->aRegulationCategory !== null && $this->regulation_category_id !== $this->aRegulationCategory->getId()) {
			$this->aRegulationCategory = null;
		}
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($this->isModified() && !$this->isColumnModified(RegulationPeer::UPDATED_AT))
			{
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(RegulationPeer::CREATED_AT))
				{
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->aRegulationCategory !== null) {
				if ($this->aRegulationCategory->isModified() || $this->aRegulationCategory->isNew()) {
					$affectedRows += $this->aRegulationCategory->save($con);
				}
				$this->setRegulationCategory($this->aRegulationCategory);
			}
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(RegulationPeer::ID) ) {
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if ($this->aRegulationCategory !== null) {
				if (!$this->aRegulationCategory->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->aRegulationCategory->getValidationFailures());
				}
			}
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			case 0:
				...
				break;
			case 1:
				return $this->getRegulationCategoryId();
				break;
			case 2:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $includeForeignObjects = false)
	{
		...
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getRegulationCategoryId(),
		...
		if ($includeForeignObjects) {
			if (null !== $this->aRegulationCategory) {
				$result['RegulationCategory'] = $this->aRegulationCategory->toArray($keyType, $includeLazyLoadColumns, true);
			}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			case 0:
				...
				break;
			case 1:
				$this->setRegulationCategoryId($value);
				break;
			case 2:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setRegulationCategoryId($arr[$keys[1]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(RegulationPeer::REGULATION_CATEGORY_ID)) $criteria->add(RegulationPeer::REGULATION_CATEGORY_ID, $this->regulation_category_id);
		if ($this->isColumnModified(RegulationPeer::CREATED_BY_ADMIN_USER_ID)) $criteria->add(RegulationPeer::CREATED_BY_ADMIN_USER_ID, $this->created_by_admin_user_id);
		if ($this->isColumnModified(RegulationPeer::TITLE)) $criteria->add(RegulationPeer::TITLE, $this->title);
		if ($this->isColumnModified(RegulationPeer::RELEASE_DATE)) $criteria->add(RegulationPeer::RELEASE_DATE, $this->release_date);
		if ($this->isColumnModified(RegulationPeer::IMAGE)) $criteria->add(RegulationPeer::IMAGE, $this->image);
		if ($this->isColumnModified(RegulationPeer::SUMMARY)) $criteria->add(RegulationPeer::SUMMARY, $this->summary);
		if ($this->isColumnModified(RegulationPeer::BODY)) $criteria->add(RegulationPeer::BODY, $this->body);
		if ($this->isColumnModified(RegulationPeer::IS_ENABLE)) $criteria->add(RegulationPeer::IS_ENABLE, $this->is_enable);
		if ($this->isColumnModified(RegulationPeer::POSITION)) $criteria->add(RegulationPeer::POSITION, $this->position);
		if ($this->isColumnModified(RegulationPeer::PAGE_VIEW)) $criteria->add(RegulationPeer::PAGE_VIEW, $this->page_view);
		if ($this->isColumnModified(RegulationPeer::SEO_KEYWORDS)) $criteria->add(RegulationPeer::SEO_KEYWORDS, $this->seo_keywords);
		if ($this->isColumnModified(RegulationPeer::SEO_DESCRIPTION)) $criteria->add(RegulationPeer::SEO_DESCRIPTION, $this->seo_description);
		if ($this->isColumnModified(RegulationPeer::CREATED_AT)) $criteria->add(RegulationPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(RegulationPeer::UPDATED_AT)) $criteria->add(RegulationPeer::UPDATED_AT, $this->updated_at);
	...
	{
		$copyObj->setRegulationCategoryId($this->regulation_category_id);
	...
	/**
	 * Declares an association between this object and a RegulationCategory object.
	 *
	 * @param      RegulationCategory $v
	 * @return     Regulation The current object (for fluent API support)
	 * @throws     PropelException
	 */
	public function setRegulationCategory(RegulationCategory $v = null)
	{
		if ($v === null) {
			$this->setRegulationCategoryId(NULL);
		} else {
			$this->setRegulationCategoryId($v->getId());
		}

		$this->aRegulationCategory = $v;

		// Add binding for other direction of this n:n relationship.
		// If this object has already been added to the RegulationCategory object, it will not be re-added.
		if ($v !== null) {
	...
	/**
	 * Get the associated RegulationCategory object
	 *
	 * @param      PropelPDO Optional Connection object.
	 * @return     RegulationCategory The associated RegulationCategory object.
	 * @throws     PropelException
	 */
	public function getRegulationCategory(PropelPDO $con = null)
	{
		if ($this->aRegulationCategory === null && ($this->regulation_category_id !== null)) {
			$this->aRegulationCategory = RegulationCategoryQuery::create()->findPk($this->regulation_category_id, $con);
			/* The following can be used additionally to
				 guarantee the related object contains a reference
				 to this object.  This level of coupling may, however, be
				 undesirable since it could result in an only partially populated collection
				 in the referenced object.
				 $this->aRegulationCategory->addRegulations($this);
			 */
		}
		return $this->aRegulationCategory;
	}
	...
	public function getAdminUser(PropelPDO $con = null)
	{
		if ($this->aAdminUser === null && ($this->created_by_admin_user_id !== null)) {
			...
			/* The following can be used additionally to
				 ...
				 undesirable since it could result in an only partially populated collection
				 in the referenced object.
				 $this->aAdminUser->addRegulations($this);
			 */
		}
	...
	{
		$this->id = null;
		$this->regulation_category_id = null;
	...
	{
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseRegulation:' . $name))
		{
