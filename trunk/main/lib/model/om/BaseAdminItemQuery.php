 ...
 * @method     AdminItemQuery orderByPosition($order = Criteria::ASC) Order by the position column
 * @method     AdminItemQuery orderByIsShowMessage($order = Criteria::ASC) Order by the is_show_message column
 * @method     AdminItemQuery orderByGetMessageAction($order = Criteria::ASC) Order by the get_message_action column
 *
 ...
 * @method     AdminItemQuery groupByPosition() Group by the position column
 * @method     AdminItemQuery groupByIsShowMessage() Group by the is_show_message column
 * @method     AdminItemQuery groupByGetMessageAction() Group by the get_message_action column
 *
 ...
 *
 * @method     AdminItemQuery leftJoinAdminItemAdminUserGroupAccess($relationAlias = null) Adds a LEFT JOIN clause to the query using the AdminItemAdminUserGroupAccess relation
 * @method     AdminItemQuery rightJoinAdminItemAdminUserGroupAccess($relationAlias = null) Adds a RIGHT JOIN clause to the query using the AdminItemAdminUserGroupAccess relation
 * @method     AdminItemQuery innerJoinAdminItemAdminUserGroupAccess($relationAlias = null) Adds a INNER JOIN clause to the query using the AdminItemAdminUserGroupAccess relation
 *
 ...
 * @method     AdminItem findOneByPosition(int $position) Return the first AdminItem filtered by the position column
 * @method     AdminItem findOneByIsShowMessage(int $is_show_message) Return the first AdminItem filtered by the is_show_message column
 * @method     AdminItem findOneByGetMessageAction(string $get_message_action) Return the first AdminItem filtered by the get_message_action column
 *
 ...
 * @method     array findByPosition(int $position) Return AdminItem objects filtered by the position column
 * @method     array findByIsShowMessage(int $is_show_message) Return AdminItem objects filtered by the is_show_message column
 * @method     array findByGetMessageAction(string $get_message_action) Return AdminItem objects filtered by the get_message_action column
 *
...
abstract class BaseAdminItemQuery extends ModelCriteria
{
	...
	public function filterByPosition($position = null, $comparison = null)
	{
		if (is_array($position)) {
			...
			if (isset($position['min'])) {
				$this->addUsingAlias(AdminItemPeer::POSITION, $position['min'], Criteria::GREATER_EQUAL);
				$useMinMax = true;
			}
			if (isset($position['max'])) {
				$this->addUsingAlias(AdminItemPeer::POSITION, $position['max'], Criteria::LESS_EQUAL);
				$useMinMax = true;
			}
			if ($useMinMax) {
				return $this;
		...
		return $this->addUsingAlias(AdminItemPeer::POSITION, $position, $comparison);
	}

	/**
	 * Filter the query on the is_show_message column
	 * 
	 * @param     int|array $isShowMessage The value to use as filter.
	 *            Accepts an associative array('min' => $minValue, 'max' => $maxValue)
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    AdminItemQuery The current query, for fluid interface
	 */
	public function filterByIsShowMessage($isShowMessage = null, $comparison = null)
	{
		if (is_array($isShowMessage)) {
			$useMinMax = false;
			if (isset($isShowMessage['min'])) {
				$this->addUsingAlias(AdminItemPeer::IS_SHOW_MESSAGE, $isShowMessage['min'], Criteria::GREATER_EQUAL);
				$useMinMax = true;
			}
			if (isset($isShowMessage['max'])) {
				$this->addUsingAlias(AdminItemPeer::IS_SHOW_MESSAGE, $isShowMessage['max'], Criteria::LESS_EQUAL);
				$useMinMax = true;
			}
			if ($useMinMax) {
				return $this;
		...
		return $this->addUsingAlias(AdminItemPeer::IS_SHOW_MESSAGE, $isShowMessage, $comparison);
	}

	/**
	 * Filter the query on the get_message_action column
	 * 
	 * @param     string $getMessageAction The value to use as filter.
	 *            Accepts wildcards (* and % trigger a LIKE)
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    AdminItemQuery The current query, for fluid interface
	 */
	public function filterByGetMessageAction($getMessageAction = null, $comparison = null)
	{
		if (null === $comparison) {
			if (is_array($getMessageAction)) {
				$comparison = Criteria::IN;
			} elseif (preg_match('/[\%\*]/', $getMessageAction)) {
				$getMessageAction = str_replace('*', '%', $getMessageAction);
				$comparison = Criteria::LIKE;
			}
		}
		return $this->addUsingAlias(AdminItemPeer::GET_MESSAGE_ACTION, $getMessageAction, $comparison);
	}
	...
	{
		return $this
			->addUsingAlias(AdminItemPeer::ID, $adminItemAdminUserGroupAccess->getAdminItemId(), $comparison);
	}
