...
abstract class BaseSettingGeneral extends BaseObject  implements Persistent
{
	...
	/**
	 * The value for the seo_meta_keywords field.
	 * @var        string
	 */
	protected $seo_meta_keywords;

	/**
	 * The value for the seo_meta_description field.
	 * @var        string
	 */
	protected $seo_meta_description;

	/**
	 * The value for the statistical_code field.
	 * @var        string
	 */
	protected $statistical_code;
	...
	/**
	 * Get the [seo_meta_keywords] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Get the [seo_meta_description] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Get the [statistical_code] column value.
	 * 
	 * @return     string
	 */
	...
	public function setSeoTitle($v)
	{
		...
		if ($this->seo_title !== $v) {
			$this->seo_title = $v;
			$this->modifiedColumns[] = SettingGeneralPeer::SEO_TITLE;
		}
	...
	/**
	 * Set the value of [seo_meta_keywords] column.
	 * 
	 * @param      string $v new value
	 * @return     SettingGeneral The current object (for fluent API support)
	 */
	public function setSeoMetaKeywords($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->seo_meta_keywords !== $v) {
			$this->seo_meta_keywords = $v;
			$this->modifiedColumns[] = SettingGeneralPeer::SEO_META_KEYWORDS;
		}
	...
	/**
	 * Set the value of [seo_meta_description] column.
	 * 
	 * @param      string $v new value
	 * @return     SettingGeneral The current object (for fluent API support)
	 */
	public function setSeoMetaDescription($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->seo_meta_description !== $v) {
			$this->seo_meta_description = $v;
			$this->modifiedColumns[] = SettingGeneralPeer::SEO_META_DESCRIPTION;
		}
	...
	/**
	 * Set the value of [statistical_code] column.
	 * 
	 * @param      string $v new value
	 * @return     SettingGeneral The current object (for fluent API support)
	 */
	public function setStatisticalCode($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->statistical_code !== $v) {
			$this->statistical_code = $v;
			$this->modifiedColumns[] = SettingGeneralPeer::STATISTICAL_CODE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->seo_meta_keywords = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			$this->seo_meta_description = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
			$this->statistical_code = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
			$this->resetModified();
			...
			return $startcol + 11; // 11 = SettingGeneralPeer::NUM_COLUMNS - SettingGeneralPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 7:
				...
				break;
			case 8:
				return $this->getSeoMetaKeywords();
				break;
			case 9:
				return $this->getSeoMetaDescription();
				break;
			case 10:
				return $this->getStatisticalCode();
				break;
			default:
				return null;
				break;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[8] => $this->getSeoMetaKeywords(),
			$keys[9] => $this->getSeoMetaDescription(),
			$keys[10] => $this->getStatisticalCode(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 7:
				...
				break;
			case 8:
				$this->setSeoMetaKeywords($value);
				break;
			case 9:
				$this->setSeoMetaDescription($value);
				break;
			case 10:
				$this->setStatisticalCode($value);
				break;
		} // switch()
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[8], $arr)) $this->setSeoMetaKeywords($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setSeoMetaDescription($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setStatisticalCode($arr[$keys[10]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SettingGeneralPeer::SEO_TITLE)) $criteria->add(SettingGeneralPeer::SEO_TITLE, $this->seo_title);
		if ($this->isColumnModified(SettingGeneralPeer::SEO_META_KEYWORDS)) $criteria->add(SettingGeneralPeer::SEO_META_KEYWORDS, $this->seo_meta_keywords);
		if ($this->isColumnModified(SettingGeneralPeer::SEO_META_DESCRIPTION)) $criteria->add(SettingGeneralPeer::SEO_META_DESCRIPTION, $this->seo_meta_description);
		if ($this->isColumnModified(SettingGeneralPeer::STATISTICAL_CODE)) $criteria->add(SettingGeneralPeer::STATISTICAL_CODE, $this->statistical_code);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setSeoMetaKeywords($this->seo_meta_keywords);
		$copyObj->setSeoMetaDescription($this->seo_meta_description);
		$copyObj->setStatisticalCode($this->statistical_code);
	...
	public function clear()
	{
		...
		$this->seo_title = null;
		$this->seo_meta_keywords = null;
		$this->seo_meta_description = null;
