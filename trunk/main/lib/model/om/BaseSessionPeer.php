...
abstract class BaseSessionPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Data', 'Time', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'data', 'time', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::DATA, self::TIME, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'DATA', 'TIME', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'data', 'time', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Data' => 1, 'Time' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'data' => 1, 'time' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::DATA => 1, self::TIME => 2, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'DATA' => 1, 'TIME' => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'data' => 1, 'time' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
