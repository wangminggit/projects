...
abstract class BaseProvincePeer {
	...
	const CLASS_DEFAULT = 'lib.model.Province';
	...
	const NAME_SHORT = 'province.NAME_SHORT';

	/** the column name for the CAPITAL field */
	const CAPITAL = 'province.CAPITAL';

	/**
	 * An identiy map to hold any loaded instances of Province objects.
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'NameShort', 'Capital', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'nameShort', 'capital', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::NAME_SHORT, self::CAPITAL, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'NAME_SHORT', 'CAPITAL', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'name_short', 'capital', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'NameShort' => 2, 'Capital' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'nameShort' => 2, 'capital' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::NAME_SHORT => 2, self::CAPITAL => 3, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'NAME_SHORT' => 2, 'CAPITAL' => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'name_short' => 2, 'capital' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	{
		if (null === $alias) {
			$criteria->addSelectColumn(ProvincePeer::ID);
			$criteria->addSelectColumn(ProvincePeer::NAME);
			$criteria->addSelectColumn(ProvincePeer::NAME_SHORT);
			$criteria->addSelectColumn(ProvincePeer::CAPITAL);
		} else {
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseProvincePeer', $criteria, $con);
		}
	 ...
	 *
	 * @param      Province $value A Province object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(Province $obj, $key = null)
	{
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = ProvincePeer::getOMClass(false);
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = ProvincePeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + ProvincePeer::NUM_COLUMNS;
		} else {
	...
	{
		return $withPrefix ? ProvincePeer::CLASS_DEFAULT : ProvincePeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a Province or Criteria object.
	 *
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(ProvincePeer::ID) && $criteria->keyContainsValue(ProvincePeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.ProvincePeer::ID.')');
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a Province or Criteria object.
	 *
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(ProvincePeer::ID);
			$value = $criteria->remove(ProvincePeer::ID);
			if ($value) {
				$selectCriteria->add(ProvincePeer::ID, $value, $comparison);
			} else {
	...
	/**
	 * Method to DELETE all rows from the province table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a Province or Criteria object OR a primary key value.
	 *
	 ...
	 */
	public static function doValidate(Province $obj, $cols = null)
	{
		$columns = array();
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(ProvincePeer::ID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(ProvincePeer::DATABASE_NAME);
			$criteria->add(ProvincePeer::ID, $pks, Criteria::IN);
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseProvincePeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
